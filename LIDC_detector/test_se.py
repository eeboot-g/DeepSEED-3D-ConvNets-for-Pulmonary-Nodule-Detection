...
parser.add_argument('--resume', default='207.ckpt', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
parser.add_argument('--save-dir', default='test_results/baseline_se_focal_newparam/', type=str, metavar='SAVE',
